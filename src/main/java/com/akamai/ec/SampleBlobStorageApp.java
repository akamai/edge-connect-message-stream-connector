...
import com.akamai.ec.producers.blob.BlobStorageProducer;

import java.util.concurrent.Executors;
import java.util.concurrent.TimeUnit;

public class SampleBlobStorageApp {

    public static void main(String[] args) {
        final BasicRecordProducer<SimpleRecord> producer = new BlobStorageProducer();
